...
class catalogo_model(models.Model):
    ...
    dimensiones = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Dimensiones', null=True, blank=True)
...
class pedidos_model(models.Model):
    ...
    codigo_temp = models.CharField(max_length=50, verbose_name='Referencia a codigo temporal', null=True, blank=True)
